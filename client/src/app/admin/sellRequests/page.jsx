      ...
      <div className='container mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          {sellRequests.map((request) => (
            <div key={request._id} className='border border-gray-200 p-4 rounded-lg'>
              ...
              <p className='text-gray-500'>Email: {request.email ? request.email : 'N/A'}</p>
              <p className='text-gray-500'>Location: {request.location}</p>
              <p className='text-gray-500'>Reg. No.: {request.registrationNumber}</p>
              <p className='text-gray-500'>Variant: {request.variant ? request.variant : 'N/A'}</p>
              <p className='text-gray-500'>Year: {request.manufactureYear}</p>
              <p className='text-gray-500'>Price: {request.price ? request.price : 'N/A'}</p>
