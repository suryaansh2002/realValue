...
const sortOptions = [
  ...
  { name: 'KM Driven: Low to High', href: '#', current: false },
  { name: 'KM Driven: High to Low', href: '#', current: false },
  { name: 'Year: Low to High', href: '#', current: false },
  { name: 'Year: High to Low', href: '#', current: false },
]
...
export default function Example({ allListings }) {
                              ...
                              {section.type == 'slider' ? (
                                <div className="space-y-6">
                                  <Slider
                                    ...
                                    tooltip={{
                                      formatter:
                                        section.id != 'year' && sliderFormatter,
                                    }}
                                    onChange={(val) =>
        ...
        <main className="px-4 sm:px-6 lg:px-8 ">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              {/* Product grid */}
              <div className="lg:col-span-3">Hi</div>
            </div>
          </section>
        </main>
      </div>
