...
const FeaturedCard = ({ car }) => {
  return (
    <a href={`/buy/${car._id}`}>
      <div className="max-w-sm rounded-lg align-top overflow-hidden shadow-md  hover:scale-105  hover:shadow-xl  transition-transform duration-200 border-2 border-transparent bg-custom-seasalt">
        <Image
          className="w-full"
          src={car.images[0]}
          width={300}
