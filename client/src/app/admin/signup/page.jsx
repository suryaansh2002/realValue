    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8'>
        ...
        {success == true ? (
          ...
          <h3 className='mt-6 text-center text-red-500 text-lg font-extrabold'>Error signing up</h3>
        ) : (
          <></>
        )}
        ...
        <div className='text-center'>
          ...
          <Link className='text-indigo-600 hover:text-indigo-700' href='/admin/login'>
            Log in
          </Link>
        </div>
      </div>
